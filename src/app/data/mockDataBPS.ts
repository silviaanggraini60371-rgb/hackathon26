...
export const mockDatasets: Dataset[] = [
  {
    ...
    sampleData: [
      { tahun: 2025, kode_provinsi: "31", nama_provinsi: "DKI Jakarta", kelompok_umur: "7-12", jenis_kelamin: "Total", aps: 99.72, jumlah_siswa: 845230 },
      { tahun: 2025, kode_provinsi: "31", nama_provinsi: "DKI Jakarta", kelompok_umur: "13-15", jenis_kelamin: "Total", aps: 98.84, jumlah_siswa: 412500 },
      { tahun: 2024, kode_provinsi: "32", nama_provinsi: "Jawa Barat", kelompok_umur: "7-12", jenis_kelamin: "Total", aps: 99.31, jumlah_siswa: 4320150 },
    ],
  ...
  },
  {
    ...
    sampleData: [
      { tahun: 2025, kode_wilayah: "31", nama_wilayah: "DKI Jakarta", rls: 11.47, hls: 15.09, jenis_kelamin: "Total" },
      { tahun: 2025, kode_wilayah: "3171", nama_wilayah: "Kota Jakarta Pusat", rls: 11.82, hls: 15.28, jenis_kelamin: "Total" },
      { tahun: 2024, kode_wilayah: "94", nama_wilayah: "Papua", rls: 7.38, hls: 11.24, jenis_kelamin: "Total" },
    ],
  ...
  },
  {
    ...
    missingValueIndicator: "-",
    sampleData: [
      { tahun: 2025, kode_provinsi: "31", nama_provinsi: "DKI Jakarta", ahh_total: 74.32, ahh_lakilaki: 72.48, ahh_perempuan: 76.28, metode: "Indirect" },
      { tahun: 2025, kode_provinsi: "51", nama_provinsi: "Bali", ahh_total: 74.68, ahh_lakilaki: 72.81, ahh_perempuan: 76.64, metode: "Indirect" },
      { tahun: 2024, kode_provinsi: "94", nama_provinsi: "Papua", ahh_total: 66.28, ahh_lakilaki: 64.82, ahh_perempuan: 67.89, metode: "Indirect" },
    ],
  ...
  },
  {
    ...
    missingValueIndicator: "n/a",
    sampleData: [
      { tahun: 2025, kode_provinsi: "31", nama_provinsi: "DKI Jakarta", stunting: 18.2, wasting: 6.4, underweight: 11.8, jumlah_sampel: 1820 },
      { tahun: 2024, kode_provinsi: "52", nama_provinsi: "Nusa Tenggara Barat", stunting: 31.5, wasting: 9.8, underweight: 19.3, jumlah_sampel: 2450 },
      { tahun: 2023, kode_provinsi: "00", nama_provinsi: "Indonesia", stunting: 21.6, wasting: 7.2, underweight: 14.1, jumlah_sampel: 58750 },
    ],
  ...
  },
  {
    ...
    missingValueIndicator: "-",
    sampleData: [
      { tahun: 2025, triwulan: 0, kode_wilayah: "31", nama_wilayah: "DKI Jakarta", lapangan_usaha: "Total", pdrb_adhk: 2548327.45, pertumbuhan: 5.82 },
      { tahun: 2025, triwulan: 0, kode_wilayah: "32", nama_wilayah: "Jawa Barat", lapangan_usaha: "Total", pdrb_adhk: 1893456.28, pertumbuhan: 5.23 },
      { tahun: 2025, triwulan: 0, kode_wilayah: "31", nama_wilayah: "DKI Jakarta", lapangan_usaha: "Informasi dan Komunikasi", pdrb_adhk: 421350.12, pertumbuhan: 8.45 },
    ],
  ...
  },
  {
    ...
    missingValueIndicator: "-",
    sampleData: [
      { tahun: 2025, bulan: "Agustus", kode_provinsi: "31", nama_provinsi: "DKI Jakarta", angkatan_kerja: 5680, bekerja: 5345, pengangguran: 335, tpt: 5.90, tpak: 70.24 },
      { tahun: 2025, bulan: "Agustus", kode_provinsi: "00", nama_provinsi: "Indonesia", angkatan_kerja: 148520, bekerja: 141280, pengangguran: 7240, tpt: 4.87, tpak: 69.81 },
      { tahun: 2024, bulan: "Februari", kode_provinsi: "51", nama_provinsi: "Bali", angkatan_kerja: 2480, bekerja: 2398, pengangguran: 82, tpt: 3.31, tpak: 73.45 },
    ],
  ...
  },
  {
    ...
    schema: [
      ...
      { columnName: "kode_provinsi", dataType: "string", definition: "Kode provinsi" },
      { columnName: "nama_provinsi", dataType: "string", definition: "Nama provinsi" },
      { columnName: "tipe_wilayah", dataType: "string", definition: "Kota/Desa/Kota+Desa" },
      { columnName: "persentase_miskin_p0", dataType: "float", unit: "%", definition: "Persentase penduduk miskin (headcount ratio)" },
      { columnName: "jumlah_miskin", dataType: "float", unit: "ribu orang", definition: "Jumlah penduduk miskin" },
      { columnName: "garis_kemiskinan", dataType: "int", unit: "rupiah/kapita/bulan", definition: "Garis Kemiskinan" },
      { columnName: "p1_poverty_gap", dataType: "float", definition: "Indeks Kedalaman Kemiskinan" },
      { columnName: "p2_poverty_severity", dataType: "float", definition: "Indeks Keparahan Kemiskinan" },
      { columnName: "gini_ratio", dataType: "float", definition: "Gini Ratio (0-1)" },
    ],
    primaryKey: "tahun, bulan, kode_provinsi, tipe_wilayah",
    missingValueIndicator: "-",
    sampleData: [
      { tahun: 2025, bulan: "Maret", kode_provinsi: "00", nama_provinsi: "Indonesia", tipe_wilayah: "Kota+Desa", persentase_miskin_p0: 9.03, jumlah_miskin: 25220, garis_kemiskinan: 524895, p1_poverty_gap: 1.42, p2_poverty_severity: 0.35, gini_ratio: 0.381 },
      { tahun: 2025, bulan: "Maret", kode_provinsi: "31", nama_provinsi: "DKI Jakarta", tipe_wilayah: "Kota+Desa", persentase_miskin_p0: 4.53, jumlah_miskin: 482.5, garis_kemiskinan: 787453, p1_poverty_gap: 0.68, p2_poverty_severity: 0.14, gini_ratio: 0.402 },
      { tahun: 2024, bulan: "September", kode_provinsi: "94", nama_provinsi: "Papua", tipe_wilayah: "Kota+Desa", persentase_miskin_p0: 26.03, jumlah_miskin: 1125.8, garis_kemiskinan: 532487, p1_poverty_gap: 4.82, p2_poverty_severity: 1.52, gini_ratio: 0.395 },
    ],
